...
import './ViewSupervisorSchedule.css'
...
function ViewSupervisorSchedule() {
    ...
    useEffect(() => {
        const fetchData = async() => {
          ...
          let response = await fetch(`${process.env.REACT_APP_BACKEND_URI}/api/supervisor/viewSchedule`, requestOptions)
...
export default ViewSupervisorSchedule