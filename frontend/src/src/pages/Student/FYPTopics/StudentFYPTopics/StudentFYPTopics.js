            ...
            const searchTopic = async(values) =>{
                if(page === 1){
                    ...
                    const requestOptions = {
                        ...
                        let response = await fetch(`${process.env.REACT_APP_BACKEND_URI}/api/student/topic/view?page=${page}&limit=5&topic_name=${values.topic_name}&genre=${genre}`, requestOptions)
                        .then((response) => {
                    ...
                    <div id='StudentFYPTopicsBase'>
                        ...
                        {topicList.length !== 0 ?
                            ...
                            <div style={{display: "flex", flexDirection: "column", justifyContent: "center", width: "100%", alignItems: "center", minHeight: "65vh"}}>
                                ...
                                <p style={{fontSize: "2vh"}}>Please contact supervisors to create one</p>
                            </div>     
                        }
                        <div id='Controller'>
